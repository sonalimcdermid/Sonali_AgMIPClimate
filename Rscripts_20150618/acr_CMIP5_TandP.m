...
%
%
function acr_CMIP5_TandP(basefile,shortname,sitename,stnlat,stnlon,mmstart,mmend);
%--------------------------------------------------
%--------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% begin debug
basefile = '/Users/sonalimcdermid/Desktop/R/data/Climate/Historical/INMH0QXX.AgMIP';
shortname = 'INMH';
sitename = 'Mahabubnagar, India';
stnlat = 16.410;
stnlon = 77.940;
mmstart = 6;
mmend = 9;
...
for thisgcm=1:length(gcmname),
  disp(thisgcm);
  load(['/Users/sonalimcdermid/Desktop/R/data/CMIP5/latlon/' gcmname{thisgcm} '_lat.mat']);
  load(['/Users/sonalimcdermid/Desktop/R/data/CMIP5/latlon/' gcmname{thisgcm} '_lon.mat']);
  ...
  cd /Users/sonalimcdermid/Desktop/R/data/CMIP5/climfiles/
...
g=figure('units','inches','pos',[.3,.3,7.9,12],'paperpos', ...
  ...
  print(f,'-depsc',['/Users/sonalimcdermid/Desktop/R/data/CMIP5_TandP/' shortname '_CMIP5_TandP_' mmname(mmstart:(mmstart+length(mmrange)-1))]);
  print(g,'-depsc',['/Users/sonalimcdermid/Desktop/R/data/CMIP5_TandP/' shortname '_CMIP5_TandPseasons']);
