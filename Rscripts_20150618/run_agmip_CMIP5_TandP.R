...
###----------------------------------------------------------------------------------------------###
####################################################################################################
#rootDir<-'/home/jmsimmo4/Scripts/RscriptsAndTestClim/RscriptsAndTestClim/R/'
#figDir <- '/home/jmsimmo4/Figures/RScript_diagnostics/'
...
shortname = 'INCO' #used for saving figures
...
# Plot deltT and deltP from Global Climate models
  agmip_CMIP5_TandP(rootDir,figDir,Basefile,shortname,stnname,stnlat,stnlon,
